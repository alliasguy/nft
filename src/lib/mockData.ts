...
const b = (bidder: string, amount: string, usd: string, time: string, gradient: string): Bid =>
  ({ bidder, amount, usd, time, gradient });
...
export const ALL_NFTS: NFTItem[] = [
  ...
  /* 1 ─ hero piece */
  {
    ...
    bids: [b("0xMaestro",  "12.5",  "48,750", "2 min ago",   "linear-gradient(135deg,#e11d48,#c026d3)"),
           b("NeonDreamer", "11.2",  "43,680", "34 min ago",  "linear-gradient(135deg,#10b981,#3b82f6)"),
           b("VoidWalker",  "9.8",   "38,220", "2 hrs ago",   "linear-gradient(135deg,#f59e0b,#ef4444)"),
           b("PixelMage",   "8.5",   "33,150", "6 hrs ago",   "linear-gradient(135deg,#8b5cf6,#ec4899)")],
  },
  ...
  /* 2 */
  {
    ...
    bids: [b("SolarArtist", "2.10", "8,190", "1 day ago", "linear-gradient(135deg,#f97316,#fbbf24)"),
           b("CathArt",     "1.80", "7,020", "3 days ago","linear-gradient(135deg,#0ea5e9,#6366f1)")],
  },
  ...
  /* 3 */
  {
    ...
    bids: [b("0xCreative",  "1.80", "7,020", "5 min ago",  "linear-gradient(135deg,#ec4899,#f43f5e)"),
           b("MetaForge",   "1.50", "5,850", "2 hrs ago",  "linear-gradient(135deg,#64748b,#334155)"),
           b("FractalLabs", "1.20", "4,680", "8 hrs ago",  "linear-gradient(135deg,#a855f7,#3b82f6)")],
  },
  ...
  /* 4 */
  {
    ...
    traits: [t("Background", "Starfield",  "10% have this"), t("Palette", "Gold-Red",       "12% have this"),
             ...
             t("Edition",    "1 of 1",     "1% have this"),  t("Style",  "Generative",       "40% have this")],
    bids: [b("NeonDreamer", "0.80", "3,120", "2 days ago", "linear-gradient(135deg,#10b981,#3b82f6)")],
  },
  ...
  /* 5 */
  {
    ...
    bids: [b("VoidWalker",  "2.90", "11,310", "4 days ago", "linear-gradient(135deg,#f59e0b,#ef4444)")],
  },
  ...
  /* 6 */
  {
    ...
    bids: [b("SolarArtist", "0.65", "2,535", "8 min ago",  "linear-gradient(135deg,#f97316,#fbbf24)"),
           b("CathArt",     "0.48", "1,872", "1 hr ago",   "linear-gradient(135deg,#0ea5e9,#6366f1)"),
           b("MetaForge",   "0.32", "1,248", "5 hrs ago",  "linear-gradient(135deg,#64748b,#334155)")],
  },
  ...
  /* 7 */
  {
    ...
    bids: [b("NeonDreamer",  "5.00", "19,500", "3 days ago", "linear-gradient(135deg,#10b981,#3b82f6)"),
           b("0xArtist",     "4.20", "16,380", "5 days ago", "linear-gradient(135deg,#e11d48,#f97316)")],
  },
  ...
  /* 8 */
  {
    ...
    traits: [t("Background", "Nebula",      "12% have this"), t("Palette",  "Violet-Blue",  "13% have this"),
             ...
             t("Style",      "Abstract",    "35% have this")],
    bids: [b("DigitalDreamer","1.00","3,900","6 hrs ago","linear-gradient(135deg,#3b82f6,#06b6d4)")],
  },
  ...
  /* 9 */
  {
    ...
    traits: [t("Background", "Cosmic",      "7% have this"), t("Palette",  "Cyan-Indigo",  "8% have this"),
             ...
             t("Edition",    "1 of 1",       "1% have this"), t("Style",  "Generative",     "40% have this")],
    bids: [b("0xCreative",  "4.50", "17,550", "2 days ago", "linear-gradient(135deg,#ec4899,#f43f5e)"),
           b("WaveLabs",    "3.80", "14,820", "5 days ago", "linear-gradient(135deg,#f59e0b,#ef4444)")],
  },
  ...
  /* 10 */
  {
    ...
    bids: [b("VoidWalker",   "2.10", "8,190",  "12 min ago", "linear-gradient(135deg,#f59e0b,#ef4444)"),
           b("PixelMage",    "1.85", "7,215",  "3 hrs ago",  "linear-gradient(135deg,#8b5cf6,#ec4899)"),
           b("SolarArtist",  "1.60", "6,240",  "9 hrs ago",  "linear-gradient(135deg,#f97316,#fbbf24)"),
           b("CryptoMaestro","1.30", "5,070",  "18 hrs ago", "linear-gradient(135deg,#e11d48,#c026d3)")],
  },
  ...
  /* 11 */
  {
    ...
    bids: [b("MetaForge",    "0.70", "2,730", "1 day ago", "linear-gradient(135deg,#64748b,#334155)")],
  },
  ...
  /* 12 */
  {
    ...
    bids: [b("0xArtist",    "6.00", "23,400", "4 hrs ago", "linear-gradient(135deg,#e11d48,#f97316)")],
  },
  ...
  /* 13 */
  {
    ...
    bids: [b("DigitalDreamer","1.95","7,605","18 min ago","linear-gradient(135deg,#3b82f6,#06b6d4)"),
           b("FractalLabs",   "1.70","6,630","4 hrs ago", "linear-gradient(135deg,#a855f7,#3b82f6)"),
           b("WaveLabs",      "1.45","5,655","12 hrs ago","linear-gradient(135deg,#f59e0b,#ef4444)")],
  },
  ...
  /* 14 */
  {
    ...
    bids: [b("NeonDreamer", "3.40","13,260","2 days ago","linear-gradient(135deg,#10b981,#3b82f6)"),
           b("CryptoMaestro","2.90","11,310","4 days ago","linear-gradient(135deg,#e11d48,#c026d3)")],
  },
  ...
  /* 15 */
  {
    ...
    traits: [t("Background", "Void",        "18% have this"), t("Palette", "Gold-Violet",   "4% have this"),
             ...
             t("Style",      "Geometric",   "30% have this")],
    bids: [b("MetaForge", "0.38","1,482","8 hrs ago","linear-gradient(135deg,#64748b,#334155)")],
  },
  ...
  /* 16 */
  {
    ...
    bids: [b("CryptoMaestro","6.80","26,520","5 days ago","linear-gradient(135deg,#e11d48,#c026d3)"),
           b("SolarArtist",  "5.90","23,010","7 days ago","linear-gradient(135deg,#f97316,#fbbf24)")],
  },
